...
//! ![pumpkins](https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Various_Pumpkins.jpg/1280px-Various_Pumpkins.jpg)
...
impl Pumpkin {
    /// If you smash the pumpking, it will be no more
    pub fn smash(self) {}
}
